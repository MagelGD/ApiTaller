...
namespace ApiTaller.Infrastructure.Migrations
{
    ...
    [Migration("20260225210801_Version4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiTaller.Domain.Models.Action", b =>
                {
                    ...
                    b.Property<int>("AplicationModuleId")
                        .HasColumnType("int(11)")
                    ...
                    b.HasIndex(new[] { "AplicationModuleId" }, "FK_ACTION_APLICATIONMODULE");
            ...
            modelBuilder.Entity("ApiTaller.Domain.Models.AplicationModule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                    ...
                    b.HasIndex(new[] { "ResponsibleUserId" }, "FK_APLICATION_MODULE_USER");

                    b.ToTable("aplication_module", (string)null);
                });
            ...
            modelBuilder.Entity("ApiTaller.Domain.Models.UserRoleModule", b =>
                {
                    ...
                    b.HasIndex(new[] { "ModulesRoleId" }, "FK_ROLE_MODULE_APLICATION_MODULE");
            ...
            modelBuilder.Entity("ApiTaller.Domain.Models.Action", b =>
                {
                    b.HasOne("ApiTaller.Domain.Models.AplicationModule", "AplicationModuleIdNavigation")
                        .WithMany()
                        .HasForeignKey("AplicationModuleId")
                        .IsRequired()
                    ...
                    b.Navigation("AplicationModuleIdNavigation");
