        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProspectName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProspectEmail = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProspectPhone = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProspectVehicleInfo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    TermsAndConditions = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WorkOrderId = table.Column<int>(type: "int(11)", nullable: true),
                    SaleId = table.Column<int>(type: "int(11)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DataBase64 = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuotationAttachment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuotationAttachment_Quotation_QuotationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceCatalogId = table.Column<int>(type: "int(11)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuotationDetail_product_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_workshop_module", x => x.id);
                    table.ForeignKey(
                        name: "FK_workshop_module_module",
                        column: x => x.module_id,
                        principalTable: "module",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_workshop_module_responsible_user",
                        column: x => x.responsible_user_id,
                        principalTable: "user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_workshop_module_workshop",
                        column: x => x.workshop_id,
                        principalTable: "workshop",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotation_ResponsibleUserIdNavigationId",
                table: "Quotation",
                column: "ResponsibleUserIdNavigationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotation_VehicleId",
                table: "Quotation",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_Quotation_WorkOrderId",
                table: "Quotation",
                column: "WorkOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_QuotationAttachment_QuotationId",
                table: "QuotationAttachment",
                column: "QuotationId");

            migrationBuilder.CreateIndex(
                name: "IX_QuotationAttachment_ResponsibleUserIdNavigationId",
                table: "QuotationAttachment",
                column: "ResponsibleUserIdNavigationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuotationDetail_ResponsibleUserIdNavigationId",
                table: "QuotationDetail",
                column: "ResponsibleUserIdNavigationId");

            migrationBuilder.CreateIndex(
                name: "IX_QuotationDetail_ServiceCatalogId",
                table: "QuotationDetail",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_workshop_module_responsible_user_id",
                table: "workshop_module",
                column: "responsible_user_id");

            migrationBuilder.CreateIndex(
                name: "UQ_workshop_module",
                table: "workshop_module",
                columns: new[] { "workshop_id", "module_id" },
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Quotation_user_ResponsibleUserIdNavigationId",
                table: "Quotation",
                column: "ResponsibleUserIdNavigationId",
                principalTable: "user",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Quotation_vehicle_VehicleId",
                table: "Quotation",
                column: "VehicleId",
                principalTable: "vehicle",
                principalColumn: "id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Quotation_work_order_WorkOrderId",
                table: "Quotation",
                column: "WorkOrderId",
                principalTable: "work_order",
                principalColumn: "id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_QuotationAttachment_user_ResponsibleUserIdNavigationId",
                table: "QuotationAttachment",
                column: "ResponsibleUserIdNavigationId",
                principalTable: "user",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_QuotationDetail_service_catalog_ServiceCatalogId",
                table: "QuotationDetail",
                column: "ServiceCatalogId",
                principalTable: "service_catalog",
                principalColumn: "id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_QuotationDetail_user_ResponsibleUserIdNavigationId",
                table: "QuotationDetail",
                column: "ResponsibleUserIdNavigationId",
                principalTable: "user",
                principalColumn: "id",
