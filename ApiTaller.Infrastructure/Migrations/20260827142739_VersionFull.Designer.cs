...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiTaller.Domain.Models.WorkshopModule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                    ...
                    b.HasIndex(new[] { "ModuleId" }, "FK_workshop_module_module");

                    b.HasIndex(new[] { "WorkshopId" }, "FK_workshop_module_workshop");

                    b.HasIndex(new[] { "WorkshopId", "ModuleId" }, "UQ_workshop_module")
                        .IsUnique();

                    b.ToTable("workshop_module", (string)null);
                });
            ...
            modelBuilder.Entity("ApiTaller.Domain.Models.WorkshopModule", b =>
                {
                    b.HasOne("ApiTaller.Domain.Models.Module", "ModuleNavigation")
                        .WithMany()
                        .HasForeignKey("ModuleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
